...
def embed_transcript_upload_pinecone(episode_sentences, user_id: str, entry_id: str, upload: bool = True):
  # Connect to Pinecone database
  pinecone.init(api_key = PINECONE_API_KEY_CONTENT, environment = 'us-west1-gcp')
